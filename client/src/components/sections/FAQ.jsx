...
const FAQ = function() {
  return (
    ...
    <small>
      <strong>Q: Do I need prior coding experience?</strong><br/>
      A: No prior experience is needed. We start with the basics and build up from there.<br/><br/>
      <strong>Q: What if I fall behind?</strong><br/>
      A: Our course is structured to help students avoid this, and the instructor is available for personal feedback daily. Also, our community forums are always available for support.<br/><br/>
      <strong>Q: How long is the course?</strong><br/>
